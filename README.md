...
There are many facilities to find your phone but they all rely on using your cellphone or Wi-Fi connection, and of course the missing phone is offline, and so it is not tracked and not locatable.

Enter **Offline Buddy**, which was conceived from this real life situation.

With Offline Buddy installed on both your phones, rerun the above scenario. You exit a shop and the Buddy alarm on your phone goes off. “Where’s your phone?” you ask your partner. “Oh \*\*\*\*, I must have left it on the counter when I paid”, and back they go to retrieve the phone. Disaster averted!

### How it works

The Buddies on each phone are connected together via Bluetooth, which is independent of any Wi-Fi and cellphone connection. It has a short range of perhaps 10 meters or so. If you and your partner (or more correctly, your phones) separate beyond the Bluetooth range, the connection breaks and your Buddy sounds the alarm.

Offline Buddy is a peer app, that is, Buddy on each devices acts in the same way. There is no concept of primary or secondary Buddy, they are equals. If you stray outside Bluetooth range, the alarm sounds on both. When you get back in range again, both phones “ping” to let you know you are back in contact. Only you know if the alarm is important. If your alarm goes off and your partner is standing beside you, you know there’s a problem!
...
**Apart** – if you’re going to be temporarily apart from your Buddy, you can suppress the alert alarm by tapping this. The ‘Apart’ time can be chosen in the settings, the default is 5 minutes. When you tap 'Apart' the same duration is set on your Buddy, keeping you in sync.
...
**Mute alarm** – turns off the alert alarm. This also stops the phone from locking. If you don’t mute the alarm when it sounds, the device will lock when the lock delay expires if the lock option is enabled.

**Sound Buddy Alarm** - sounds the alarm on your Buddy's phone. Useful if you know it's nearby but can't see it.

Offline Buddy has a simple **message** facility on the lower part of the main screen. Messages to your Buddy will appear on their screen and a notification will be made.

You use the **configure screen** to select your Buddy device. If the device you want isn’t shown, you will need to pair it with your phone by using the ‘Connected Devices’ page in the Android settings. If you want to change the currently configured Buddy device you will need to restart the app.

The **settings screen** lets you set app preferences, for example the length of the alert alarm and the choice of screen locking.
